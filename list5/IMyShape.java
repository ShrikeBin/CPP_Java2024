...
/**
 * Represents a shape in the application.
 */
public interface IMyShape {
    
    /**
     * Sets the event handler for mouse clicks on the shape.
     * 
    ...
    /**
     * Sets the event handler for mouse press on the shape.
     * 
    ...
    /**
     * Sets the event handler for mouse scroll on the shape.
     * 
    ...
    /**
     * Paints the shape with the given color.
     * 
    ...
    /**
     * Resizes the shape by a given scale factor.
     * 
    ...
    /**
     * Moves the shape to a specified destination.
     * 
    ...
    /**
     * Returns the list of basic points defining the shape.
     * 
    ...
    /**
     * Sets the list of basic points defining the shape.
     * 
    ...
    /**
     * Checks if the given coordinates are inside the shape.
     * 
    ...
    /**
     * Returns the data representation of the shape.
     * 
